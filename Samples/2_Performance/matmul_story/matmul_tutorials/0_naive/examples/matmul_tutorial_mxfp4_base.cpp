...
#include "../include/kernel/quant_matmul_mx_kernel_imp_basel.h"
...
int main(int argc, char* argv[])
{
    ...
    aclFinalize();
    std::string verify_script = "python3 \"Samples/2_Performance/matmul_story/matmul_tutorials/common/golden/quant_matmul_mxfp4/verify_result.py\"";
