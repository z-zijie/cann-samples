...
/*!
 * \file fia_demo_prompt_flash_attention_entry_regbase.h
 * \brief
 */
...
#include "fia_demo_template_tiling_key_enum.h"
...
template <uint8_t inOutLayoutType, uint16_t config, bool hasAttenMask>
