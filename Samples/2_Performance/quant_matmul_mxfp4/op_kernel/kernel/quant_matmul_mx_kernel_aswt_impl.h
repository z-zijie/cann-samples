...
#include "../block/quant_matmul_mx_block_mmad_aswt.h"
#include "../block/quant_matmul_mx_block_scheduler_aswt.h"
...
public:
    ...
    __aicore__ inline void Init(const Params& params)
    {
        ...
        scaleAGlobal_.SetGlobalBuffer(reinterpret_cast<__gm__ fp8_e8m0_t*>(blockMmadParams.pertokenScaleGmAddr));
        scaleBGlobal_.SetGlobalBuffer(reinterpret_cast<__gm__ fp8_e8m0_t*>(blockMmadParams.scaleGmAddr));
    }
    ...
    __aicore__ inline void operator()(const Params& params)
    {
        ...
        for (int64_t tileIdx = curBlockIdx; tileIdx < tileNum; tileIdx += blockNum) {
            ...
            auto blockOffset = GetMxOffsetWithoutLayout(blockCoord, problemShape_);
            ...
            int64_t offsetX1Scale = Get<3>(blockOffset);
            int64_t offsetX2Scale = Get<4>(blockOffset);
            blockMmadOp(cGlobal_[offsetC], aGlobal_[offsetA], bGlobal_[offsetB], scaleAGlobal_[offsetX1Scale],
                        scaleBGlobal_[offsetX2Scale], blockShape);
        }
        return;
    }
};
...
#endif // QUANT_MATMUL_MX_KERNEL_ASWT_IMPL_H
