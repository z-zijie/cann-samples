...
uint8_t FiaTiling::SetPlatMemoryInfo(ContextParamsForTiling& contextKeyParams) {
...
uint8_t FiaTiling::SetAttributeInfo(ContextParamsForTiling&contextKeyParams){
    actSeqLenDims=0;
    actSeqLenKVDims = 0;
    enableActSeqLen = 0;
    enableActSeqLenKV = 0;
...
bool FiaTiling::SetInputLayout(string& layout) {
...
bool FiaTiling::SetShape(FIAShapeInfo& shapeInfo, ContextParamsForTiling& contextKeyParams, const std::string inputName) {
...
bool FiaTiling::SetHeadNumRatio(ContextParamsForTiling& contextKeyParams) {
...
bool FiaTiling::SetMaskTypeAndShape(ContextParamsForTiling& contextKeyParams) {
    const at::IntArrayRef attenMaskShape = contextKeyParams.attentionMaskShape;
...
void FiaTiling::SetSparseModeData(ContextParamsForTiling& contextKeyParams,
...
void FiaTiling::SetSparseType(uint32_t qS)
{
...
bool FiaTiling::SetSparseMode(ContextParamsForTiling& contextKeyParams,uint32_t qS) {
    const int32_t sparseMode = contextKeyParams.sparseMode;
...
uint8_t FiaTiling::CheckSingleAttribute(ContextParamsForTiling& contextKeyParams, FIAShapeInfo& queryShapeInfo,
...
void FiaTiling::SetTilingDataAttribute(ContextParamsForTiling& contextKeyParams) {
...
void FiaTiling::SetTilingData(ContextParamsForTiling& contextKeyParams, FIAShapeInfo& queryShapeInfo, FIAShapeInfo& valueShapeInfo) {
    //  IFA flag
...
void FiaTiling::InferSplitCoreMode() {
    splitCoreMode = SplitCoreMode::SPLIT_NBS_CUBE;
}

bool FiaTiling::AdjustCVTilingCVDiff(const ContextParamsForTiling& contextKeyParams,
...
uint8_t FiaTiling::AdjustTilingData(ContextParamsForTiling& contextKeyParams, const FIAShapeInfo& queryShapeInfo,
    const FIAShapeInfo& valueShapeInfo) {
...
uint8_t FiaTiling::SetQKVStartIdx(ContextParamsForTiling& contextKeyParams) {
...
void FiaTiling::SetAttenMaskCompressMode()
{
...
void FiaTiling::FlashAttentionInitOutputSplit(int64_t totalSize) {
...
void FiaTiling::GetPreNextTokensLeftUp(int64_t actualSeqLength, int64_t actualSeqLengthKV, int64_t& preTokensLeftUp, int64_t& nextTokensLeftUp) {
...
void FiaTiling::FixParamWithRowInvalid(int64_t& actualSeqLength, int64_t actualSeqLengthKV,
...
int64_t FiaTiling::GetCutBlockNums(int64_t blockSeqLengthKV, int64_t blockSeqLength,
...
int64_t FiaTiling::GetCalcBlockNumsOneHead(int64_t actualSeqLength, int64_t actualSeqLengthKV,
...
int64_t FiaTiling::GetSInnerBlockNums(int64_t sInnerIndexStart, int64_t sInnerIndexEnd, int64_t innerBlockNums) {
...
void FiaTiling::ComputeSplitNBSeq(uint32_t batchSize,
...
void FiaTiling::SetMultiCoreParamsRegbase(int64_t totalSize, int64_t actualUsedCoreNum)
{
 ...
 bool FiaTiling::CheckMaskShape(ContextParamsForTiling& contextKeyParams, const int32_t* sparseMode,
...
bool FiaTiling::CheckMaskShapeCrossSparse(ContextParamsForTiling& contextKeyParams,
...
uint8_t FiaTiling::CheckCrossoverAttribute(ContextParamsForTiling& contextKeyParams,
...
bool FiaTiling::ParseActualSeqLengths(ContextParamsForTiling& contextKeyParams,
...
bool FiaTiling::CheckMultiFeatureCrossover(ContextParamsForTiling& contextKeyParams,
    FIAShapeInfo& queryShapeInfo, std::vector<int64_t>& actualSeqLengths, std::vector<int64_t>& actualSeqLengthsKV) {
...
void FiaTiling::FlashAttentionSplitNBSeq(std::vector<int64_t>& actualSeqLengths, std::vector<int64_t>& actualSeqLengthsKV, bool isAttenMaskUsed) {
...
uint8_t FiaTiling::ComputeTilingData(ContextParamsForTiling& contextKeyParams,
...
void FiaTiling::TilingDataconvert() {
    SetLayoutType();
    auto &inputParams = faTilingAdapter.inputParamsRegbase;
...
uint8_t FiaTiling::DoTiling(ContextParamsForTiling& contextKeyParams)
{
