...
template <uint64_t ENABLE_A_FULL_LOAD = 0>
    ...
    const QuantMatmulTilingData quantMatmulTilingData)
{
    ...
    using BlockScheduler = QuantMatmulMxAswtScheduler<ENABLE_A_FULL_LOAD>;
    using DispatchPolicy = QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, ENABLE_A_FULL_LOAD>;
