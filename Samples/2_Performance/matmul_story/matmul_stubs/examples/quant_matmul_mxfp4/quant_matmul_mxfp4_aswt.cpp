...
constexpr static uint64_t DISABLE_A_FULL_LOAD_TAG = 0;
constexpr static uint64_t ENABLE_A_FULL_LOAD_TAG = 1;
...
// template <uint64_t A_FULL_LOAD_MODE>
    ...
    const QuantMatmulTilingData quantMatmulTilingData)
{
    ...
    using BlockScheduler = QuantMatmulMxAswtScheduler<DISABLE_A_FULL_LOAD_TAG>;
    using DispatchPolicy = QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, DISABLE_A_FULL_LOAD_TAG>;
...
int main(int argc, char* argv[])
{
    ...
    //     QuantMatmulMxfp4Kernel<ENABLE_A_FULL_LOAD_TAG><<<quantMatmulTilingData.usedCoreNum, nullptr, stream>>>(
    //         dA, dB, dScaleA, dScaleB, dC, quantMatmulTilingData);
    // } else {
