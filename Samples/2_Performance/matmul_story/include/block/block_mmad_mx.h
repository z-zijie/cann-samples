...
class BlockMmadMx<
    ...
    AscendC::Std::enable_if_t<
        AscendC::Std::is_base_of_v<
            QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, DISABLE_A_FULL_LOAD>, DispatchPolicy_> ||
        AscendC::Std::is_base_of_v<
            QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, ENABLE_A_FULL_LOAD>, DispatchPolicy_>>> {
public:
    using AType = AType_;
    using BType = BType_;
    using CType = CType_;
...
public:
                                ...
                                const L1Params &l1Params, bool dbL0C)
    {
        ...
        if constexpr (DispatchPolicy::enableAFullLoad == 0) {
            ...
            l1BufferAOffset_[0] = bL1OneBuffer_ * (l1BufNum_ >> 1) + ((scaleBL1OneBuffer_) << 1);
                                        ...
                                        uint64_t kL1Offset)
    {
        ...
        if (DispatchPolicy::enableAFullLoad != 0 && kL1Offset != 0) {
            return;
        }
                                   ...
                                   uint64_t scaleL1BufId, uint64_t offsetAl1, uint64_t l0cOffset)
    {
        ...
        for (uint16_t iter1 = 0; iter1 < kL0Iter; ++iter1) {
            ...
            AscendC::Mmad(c1Local_[l0cOffset], l0aLocal_[l0Offset], l0bLocal_[l0Offset], mmadParams);
