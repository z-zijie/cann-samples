    ...
    const QuantMatmulTilingData quantMatmulTilingData)
{
    ...
    using BlockScheduler = QuantMatmulMxAswtScheduler<A_FULL_LOAD_MODE>;
    using DispatchPolicy = QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, A_FULL_LOAD_MODE>;
