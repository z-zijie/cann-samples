...
#include "../block/flash_attention_score_block_cube.h"
#include "../block/flash_attention_score_block_vec_infer.h"
    ...
    const FlashAttentionScoreSimplifiedTilingData *__restrict tiling, TPipe *tPipe)
{
    ...
    this->pipe = tPipe;
    vecBlock.InitVecBlock(tPipe, this->tilingData, this->sharedParams, this->aicIdx, constInfo.subBlockIdx, attenMaskInfo);
