...
constexpr static int MXFP_MULTI_BASE_SIZE = 2;
constexpr static int MX_DIVISOR_SIZE = 64;
...
int main(int argc, char* argv[])
{
    ...
    size_t sizeScaleA = (m * CeilDiv(k, MX_DIVISOR_SIZE) * MXFP_MULTI_BASE_SIZE) * sizeof(uint8_t);
    size_t sizeScaleB = (n * CeilDiv(k, MX_DIVISOR_SIZE) * MXFP_MULTI_BASE_SIZE) * sizeof(uint8_t);
