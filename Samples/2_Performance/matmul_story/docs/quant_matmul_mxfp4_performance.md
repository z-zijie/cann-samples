...
MTE2的综合带宽包含了DDR带宽和L2带宽的共同作用，主要受各自部分的搬运量影响。

综合带宽可以简化成**DDR的搬运耗时+L2的搬运耗时**，所以MTE2的搬运时间也可以用下面的公式表示：

$$
T_{mte2} \approx \frac{DDR搬运量}{DDR带宽} + \frac{L2搬运量}{L2带宽} = \frac{Size_{DDR}}{BandWidth_{DDR}} + \frac{Size_{L2}}{BandWidth_{L2}}
$$
...
- **模板实现**：`quant_matmul_mxfp4_swat.cpp`
