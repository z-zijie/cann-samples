...
- [matmul](./matmul_stubs/examples/matmul/README.md)：非量化矩阵乘算子优化实践 [Float16/Bfloat16/Float32]
- [quant_matmul_mxfp4](./matmul_stubs/examples/quant_matmul_mxfp4/README.md)：MXFP4量化矩阵乘算子优化实践
