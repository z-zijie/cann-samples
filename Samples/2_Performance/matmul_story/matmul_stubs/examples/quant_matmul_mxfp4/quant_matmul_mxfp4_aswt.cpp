    ...
    const QuantMatmulTilingData quantMatmulTilingData)
{
    ...
    using BlockScheduler = QuantMatmulMxAswtScheduler<FULL_LOAD_MODE>;
    using DispatchPolicy = QuantMatmulMxMultiBlockWithAswt<AscendC::Shape<_0, _0, _0, _0>, FULL_LOAD_MODE>;
