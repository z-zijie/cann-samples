...
public:
    ...
    __aicore__ inline void Init(GM_ADDR shmemSpace, GM_ADDR x, GM_ADDR expertIds, GM_ADDR scales, GM_ADDR xActiveMask, GM_ADDR elasticInfo, GM_ADDR performanceInfo,
...
__aicore__ inline void MoeDistributeDispatchV2FullMesh<TemplateMC2TypeFullmeshFunc>::SetDataStatus()
{
    ...
    statusDataSpaceGM_ = GetWindStateAddrByRankId(COMM_EP_IDX, epRankIdOriginal_);
    epRankIdHccl = epRankIdOriginal_;
...
template <TemplateMC2TypeFullmeshClass>
__aicore__ inline void MoeDistributeDispatchV2FullMesh<TemplateMC2TypeFullmeshFunc>::Init(GM_ADDR shmemSpace, GM_ADDR x, 
